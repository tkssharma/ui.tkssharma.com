  ...
  <FooterWrapper>
    <FooterGroup>
      <Navbar>
        ...
        >
          Tarun Sharma © {new Date().getFullYear()} - version 5
        </p>
        <FooterLink href="https://twitter.com/tkssharma">
          <p style={{ color: '#9a9a9b', fontSize: '14px', fontWeight: '400' }}>
            Twitter
          </p>
        </FooterLink>
        <FooterLink href="https://tinyletter.com/tkssharma">
          <p style={{ color: '#9a9a9b', fontSize: '14px', fontWeight: '400' }}>
            Newsletter
          </p>
        </FooterLink>
        <FooterLink href="https://ko-fi.com/tkssharma">
          <p style={{ color: '#9a9a9b', fontSize: '14px', fontWeight: '400' }}>
            Ko-fi
          </p>
        </FooterLink>
